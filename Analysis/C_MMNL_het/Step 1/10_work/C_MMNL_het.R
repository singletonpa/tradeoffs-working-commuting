...
apollo_randCoeff <- function(apollo_beta, apollo_inputs) {
  ...
  randcoeff[["g_TT"]] =  exp(m_g_TT + s_g_TT * draws_g_TT + 
                               bt_dept_aen*TIMEDEP_AfterEveNight + bt_noflexwh*FLEXWORK_No + bt_nopriinc*PRIMWORK_No) 
  randcoeff[["g_WT"]] =  exp(m_g_WT + s_g_WT * draws_g_WT + s_TTWT * draws_g_TT + 
                               bw_dept_aen*TIMEDEP_AfterEveNight + bw_noflexwh*FLEXWORK_No + bw_nopriinc*PRIMWORK_No) 
