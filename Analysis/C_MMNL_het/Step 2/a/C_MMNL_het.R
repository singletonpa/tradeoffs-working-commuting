...
apollo_randCoeff <- function(apollo_beta, apollo_inputs) {
  ...
  randcoeff[["g_WT"]] =  exp(m_g_WT + s_g_WT * draws_g_WT + s_TTWT * draws_g_TT + 
                               ...
                               bw_educ_hsl*EDUC_L_HS + bw_pt_subur*PLACETYPE_Sub_Urban + 
                               bw_pt_subsu*PLACETYPE_Suburban + bw_pt_rural*PLACETYPE_Rural_all + 
                               bw_cmode_at*MODE_Active + 
                               bw_sat_work*SAT_WORK + bw_sat_comm*SAT_COMM)
