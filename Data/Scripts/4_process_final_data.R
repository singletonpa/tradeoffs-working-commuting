...
dw$PLACETYPE <- ifelse(is.na(dw$PLACE_LIVE) |
                         is.na(dw$PLACE_WORK), NA, 
                ifelse(dw$PLACE_LIVE=="Rural" |
                         dw$PLACE_WORK=="Rural", "Rural_all", 
                ifelse(dw$PLACE_LIVE=="Suburban" &
                         dw$PLACE_WORK=="Suburban", "Suburban", 
                ifelse(dw$PLACE_LIVE=="Suburban" &
                         dw$PLACE_WORK=="Urban", "Sub_Urban", 
                ifelse(dw$PLACE_LIVE=="Urban" &
                         dw$PLACE_WORK=="Suburban", "Sub_Urban", 
                ifelse(dw$PLACE_LIVE=="Urban" &
                         dw$PLACE_WORK=="Urban", "Urban", NA))))))
...
dw <- cbind(dw, Data[, c("COMMUTE", "WDAYS", "CDAYS", "MODE", "PARKCOST", "TOLLCOST",
...
# travel time
dl %>%
  mutate(TT_A = ifelse(name %in% c("M1Q4", "M1Q8", "M2Q3",
                                   "M2Q5", "M2Q10"), MD12TT1, 
                ifelse(name %in% c("M1Q3", "M1Q6", 
                                   "M2Q2", "M2Q6"), MD12TT2, 
                ifelse(name %in% c("M1Q9", "M1Q10",
                                   "M2Q8"), MD12TT3, 
                ifelse(name %in% c("M1Q2", "M1Q5", "M1Q7", 
                                   "M2Q7", "M2Q9"), MD12TT4, 
                ifelse(name %in% c("M1Q1", "M2Q1", "M2Q4"), MD12TT5, 
                ifelse(name %in% c("M3Q3", "M3Q7", "M4Q1", 
                                   "M4Q4", "M5Q3", "M5Q7"), MD345TT1, 
                ifelse(name %in% c("M3Q6", "M3Q9", "M4Q2",
                                   "M5Q6", "M5Q9"), MD345TT2, 
                ifelse(name %in% c("M3Q2", "M3Q10","M4Q5",
                                   "M4Q9", "M5Q2", "M5Q10"), MD345TT3, 
                ifelse(name %in% c("M3Q1", "M3Q4", "M4Q6",
                                   "M4Q7", "M4Q10","M5Q1", "M5Q4"), MD345TT4, 
                ifelse(name %in% c("M3Q5", "M3Q8", "M4Q3",
                                   "M4Q8", "M5Q5", "M5Q8"), MD345TT5, 
                       0))))))))))) -> dl
# travel cost
dl %>%
  mutate(TC_A = ifelse(name %in% c("M1Q2", "M1Q7", 
                                   "M1Q10", "M5Q4"), M15TC1, 
                ifelse(name %in% c("M1Q3", "M5Q7",
                                   "M5Q8"), M15TC2, 
                ifelse(name %in% c("M1Q6", "M1Q8", "M5Q2",
                                   "M5Q3"), M15TC3, 
                ifelse(name %in% c("M1Q1", "M1Q4", "M5Q5",
                                   "M5Q10"), M15TC4, 
                ifelse(name %in% c("M1Q5", "M1Q9", "M5Q1",
                                   "M5Q6", "M5Q9"), M15TC5, 
                ifelse(name %in% c("M3Q4"), M3TC1, 
                ifelse(name %in% c("M3Q7", "M3Q8"), M3TC2, 
                ifelse(name %in% c("M3Q2", "M3Q3"), M3TC3, 
                ifelse(name %in% c("M3Q5", "M3Q10"), M3TC4, 
                ifelse(name %in% c("M3Q1", "M3Q6", "M3Q9"), M3TC5, 
                       0))))))))))) -> dl
# work time
dl %>%
  mutate(WT_A = ifelse(name %in% c("M1Q3", "M1Q8", "M2Q3",
                                   "M2Q7", "M2Q8"), MD12WT1, 
                ifelse(name %in% c("M1Q5", "M1Q9", "M2Q5", "M2Q9"), MD12WT2, 
                ifelse(name %in% c("M1Q6", "M1Q7", "M2Q1", "M2Q4"), MD12WT3, 
                ifelse(name %in% c("M1Q4", "M2Q6", "M2Q10"), MD12WT4, 
                ifelse(name %in% c("M1Q1", "M1Q2", "M1Q10","M2Q2"), MD12WT5, 
                ifelse(name %in% c("M3Q10","M4Q9", "M5Q10"), MD345WT1, 
                ifelse(name %in% c("M3Q2", "M3Q3", "M3Q4",
                                   "M4Q5", "M5Q2", "M5Q3", "M5Q4"), MD345WT2, 
                ifelse(name %in% c("M3Q8", "M3Q9", "M4Q4",
                                   "M5Q8", "M5Q9"), MD345WT3, 
                ifelse(name %in% c("M3Q5", "M3Q6", "M4Q2", "M4Q6", 
                                   "M4Q7", "M5Q5", "M5Q6"), MD345WT4, 
                ifelse(name %in% c("M3Q1", "M3Q7", "M4Q1", "M4Q3",
                                   "M4Q8", "M4Q10","M5Q1", "M5Q7"), MD345WT5, 
                       0))))))))))) -> dl

# income
dl %>%
  mutate(IN_A = ifelse(name %in% c("M1Q3", "M1Q6", "M2Q5", 
                                   "M2Q8"), MD12INC1, 
                ifelse(name %in% c("M1Q4", "M1Q8", "M2Q3",
                                   "M2Q7", "M2Q10"), MD12INC2, 
                ifelse(name %in% c("M1Q5", "M2Q2", 
                                   "M2Q6"), MD12INC3, 
                ifelse(name %in% c("M1Q1", "M1Q9", "M2Q1",
                                   "M2Q4"), MD12INC4, 
                ifelse(name %in% c("M1Q2", "M1Q7", "M1Q10",
                                   "M2Q9"), MD12INC5, 
                ifelse(name %in% c("M3Q2", "M3Q3", "M4Q4",
                                   "M4Q9", "M5Q2", "M5Q3"), MD345INC1, 
                ifelse(name %in% c("M3Q4", "M3Q7", "M4Q5",
                                   "M5Q4", "M5Q7"), MD345INC2, 
                ifelse(name %in% c("M3Q10","M4Q1", "M4Q2",
                                   "M5Q10"), MD345INC3, 
                ifelse(name %in% c("M3Q5", "M3Q6", "M3Q9", "M4Q3",
                                   "M4Q6", "M4Q8", "M5Q5", "M5Q6", 
                                   "M5Q9"), MD345INC4, 
                ifelse(name %in% c("M3Q1", "M3Q8", "M4Q7"
                                   , "M4Q10","M5Q1", "M5Q8"), MD345INC5, 
                       0))))))))))) -> dl

# Add attributes: Alternative B
# travel time
dl %>%
  mutate(TT_B = ifelse(name %in% c("M1Q5", "M1Q7", "M2Q7", "M2Q9"), MD12TT1, 
                ifelse(name %in% c("M1Q3", "M1Q9", "M2Q2", "M2Q5"), MD12TT2, 
                ifelse(name %in% c("M1Q1", "M2Q1", "M2Q10"), MD12TT3, 
                ifelse(name %in% c("M1Q2", "M1Q4", "M1Q10",
                                   "M2Q3", "M2Q6"), MD12TT4, 
                ifelse(name %in% c("M1Q6", "M1Q8", "M2Q4", "M2Q8"), MD12TT5, 
                ifelse(name %in% c("M3Q4", "M3Q5", "M4Q6",
                                   "M5Q4", "M5Q5"), MD345TT1, 
                ifelse(name %in% c("M3Q8", "M3Q10","M4Q3",
                                   "M4Q5", "M4Q8", "M5Q8", "M5Q10"), MD345TT2, 
                ifelse(name %in% c("M3Q7", "M3Q9", "M4Q4",
                                   "M5Q7", "M5Q9"), MD345TT3, 
                ifelse(name %in% c("M3Q1", "M3Q6", "M4Q1",
                                   "M4Q7", "M5Q1", "M5Q6"), MD345TT4, 
                ifelse(name %in% c("M3Q2", "M3Q3", "M4Q2", 
                                   "M4Q9", "M4Q10","M5Q2", "M5Q3"), MD345TT5, 
                       0))))))))))) -> dl
# travel cost
dl %>%
  mutate(TC_B = ifelse(name %in% c("M1Q5", "M1Q9", "M5Q6",
                                   "M5Q9", "M5Q10"), M15TC1, 
                ifelse(name %in% c("M1Q4", "M1Q8", "M5Q7"), M15TC2, 
                ifelse(name %in% c("M1Q1", "M5Q4", "M5Q5"), M15TC3, 
                ifelse(name %in% c("M1Q2", "M1Q3", "M1Q6",
                                   "M5Q1", "M5Q2"), M15TC4, 
                ifelse(name %in% c("M1Q7", "M1Q10","M5Q3", "M5Q8"), M15TC5, 
                ifelse(name %in% c("M3Q6", "M3Q9", "M3Q10"), M3TC1, 
                ifelse(name %in% c("M3Q7"), M3TC2, 
                ifelse(name %in% c("M3Q4", "M3Q5"), M3TC3, 
                ifelse(name %in% c("M3Q1", "M3Q2"), M3TC4, 
                ifelse(name %in% c("M3Q3", "M3Q8"), M3TC5, 
                       0))))))))))) -> dl
# work time
dl %>%
  mutate(WT_B = ifelse(name %in% c("M1Q1", "M1Q2", "M1Q4",
                                   "M2Q2", "M2Q10"), MD12WT1, 
                ifelse(name %in% c("M1Q10","M2Q4"), MD12WT2, 
                ifelse(name %in% c("M1Q5", "M1Q8", "M2Q6", "M2Q7"), MD12WT3, 
                ifelse(name %in% c("M1Q7", "M1Q9", "M2Q8", "M2Q9"), MD12WT4, 
                ifelse(name %in% c("M1Q3", "M1Q6", "M2Q1",
                                   "M2Q3", "M2Q5"), MD12WT5, 
                ifelse(name %in% c("M3Q1", "M3Q7", "M4Q4", "M4Q6", 
                                   "M4Q7", "M5Q1", "M5Q7"), MD345WT1, 
                ifelse(name %in% c("M3Q4", "M3Q10","M4Q1", "M4Q3",
                                   "M5Q4", "M5Q10"), MD345WT2, 
                ifelse(name %in% c("M3Q5", "M4Q8", "M4Q9", "M5Q5"), MD345WT3, 
                ifelse(name %in% c("M3Q3", "M3Q6", "M3Q8", "M4Q5",
                                   "M4Q10","M5Q3", "M5Q6", "M5Q8"), MD345WT4, 
                ifelse(name %in% c("M3Q2", "M3Q9", "M4Q2", "M5Q2",
                                   "M5Q9"), MD345WT5, 
                       0))))))))))) -> dl

# income
dl %>%
  mutate(IN_B = ifelse(name %in% c("M1Q1", "M2Q7"), MD12INC1, 
                ifelse(name %in% c("M1Q4", "M1Q5", "M2Q2", "M2Q10"), MD12INC2, 
                ifelse(name %in% c("M1Q3", "M1Q9", "M2Q4", "M2Q5"), MD12INC3, 
                ifelse(name %in% c("M1Q2", "M1Q6", "M1Q8", "M2Q6", 
                                   "M2Q8"), MD12INC4, 
                ifelse(name %in% c("M1Q7", "M1Q10","M2Q1", "M2Q3",
                                   "M2Q9"), MD12INC5, 
                ifelse(name %in% c("M3Q4", "M3Q5", "M4Q6", "M4Q8",
                                   "M5Q4", "M5Q5"), MD345INC1, 
                ifelse(name %in% c("M3Q7", "M3Q10","M4Q3", "M4Q4",
                                   "M5Q7", "M5Q10"), MD345INC2, 
                ifelse(name %in% c("M3Q1", "M4Q1", "M4Q5", "M5Q1"), MD345INC3, 
                ifelse(name %in% c("M3Q6", "M3Q9", "M4Q2", "M4Q7",
                                   "M4Q9", "M5Q6", "M5Q9"), MD345INC4, 
                ifelse(name %in% c("M3Q2", "M3Q3", "M3Q8", "M4Q10",
                                   "M5Q2", "M5Q3", "M5Q8"), MD345INC5, 
                       0))))))))))) -> dl
